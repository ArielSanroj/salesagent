...
class TestOutboundSystem:
    ...
    def test_initialize_services_success(self):
        ...
        with patch("outbound.CredentialsManager") as mock_creds, patch(
            "outbound.LLMService"
        ) as mock_llm, patch("outbound.create_session") as mock_session:
    ...
    def test_filter_results(self):
        ...
        assert (
            filtered[0].relevance_score >= filtered[1].relevance_score
        )  # Sorted by score
