...
class LintAndTestRunner:
    ...
    def run_black_check(self) -> bool:
        ...
        return self.run_command(
            ["black", "--check", "--diff", "src/", "tests/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
    ...
    def run_isort_check(self) -> bool:
        ...
        return self.run_command(
            ["isort", "--check-only", "--diff", "src/", "tests/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
    ...
    def run_flake8(self) -> bool:
        """Run flake8 linting"""
        return self.run_command(
            ["flake8", "src/", "tests/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
            "Flake8 linting"
        )
    ...
    def run_mypy(self) -> bool:
        ...
        return self.run_command(
            ["mypy", "src/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
            "MyPy type checking"
        )
    ...
    def run_bandit(self) -> bool:
        ...
        return self.run_command(
            ["bandit", "-r", "src/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
    ...
    def fix_formatting(self) -> bool:
        ...
        black_result = self.run_command(
            ["black", "src/", "tests/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
            "Black code formatting"
        )
        
        # Run isort
        isort_result = self.run_command(
            ["isort", "src/", "tests/", "outbound.py", "gmail_email_system.py", "weekly_scheduler.py"],
