...
class GmailEmailSystem:
    ...
    def get_gmail_service(self):
        ...
        try:
            ...
            if os.path.exists(token_file):
                creds = Credentials.from_authorized_user_file(token_file, gmail_config["scopes"])
    ...
    def generate_email_content(self, opportunity: Dict[str, Any]) -> Dict[str, str]:
        ...
        try:
            ...
            template_name = self.get_template_for_signal(opportunity.get("signal_type", 1))
            ...
            if opportunity.get("signal_type") == 3:  # High-intent content
                variables["content_topic"] = "HR technology"  # Could be extracted from content
    ...
    def create_draft(self, email_content: Dict[str, str]) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            logging.info(f"Created draft for {email_content['to']} at {email_content['company']}")
            return {
                "id": draft['id'],
                "to": email_content["to"],
    ...
    def create_batch_drafts(self, opportunities: List[Dict[str, Any]]) -> List[Dict[str, str]]:
    ...
    def validate_template(self, template: Dict[str, str]) -> bool:
        ...
        required_fields = ["subject_template", "opening_template", "body_template", "closing_template"]
    ...
    def save_draft_summary(self, drafts: List[Dict[str, str]], filename: str = "email_drafts_summary.json"):
